...
class BackBone(nn.Module):
    def __init__(self, input_size, input_channel, layers):
        ...
        self.layer3x3_1 = self._make_layer3(SEBlock3x3, 64, layers[0], stride=1)
        self.layer3x3_2 = self._make_layer3(SEBlock3x3, 128, layers[1], stride=1)
        self.layer3x3_3 = self._make_layer3(SEBlock3x3, 128, layers[2], stride=2)
        self.layer3x3_4 = self._make_layer3(SEBlock3x3, 256, layers[3], stride=2)
        self.maxpool3 = nn.AvgPool1d(kernel_size=16, stride=1, padding=0)

        self.layer5x5_1 = self._make_layer5(SEBlock5x5, 64, layers[0], stride=1)
        self.layer5x5_2 = self._make_layer5(SEBlock5x5, 128, layers[1], stride=1)
        self.layer5x5_3 = self._make_layer5(SEBlock5x5, 128, layers[2], stride=2)
        self.layer5x5_4 = self._make_layer5(SEBlock5x5, 256, layers[3], stride=2)
        self.maxpool5 = nn.AvgPool1d(kernel_size=11, stride=1, padding=0)

        self.layer7x7_1 = self._make_layer7(SEBlock7x7, 64, layers[0], stride=1)
        self.layer7x7_2 = self._make_layer7(SEBlock7x7, 128, layers[1], stride=1)
        self.layer7x7_3 = self._make_layer7(SEBlock7x7, 128, layers[2], stride=2)
        self.layer7x7_4 = self._make_layer7(SEBlock7x7, 256, layers[3], stride=2)
...
class SEBlock5x5(nn.Module):
    expansion = 1

    def __init__(self, inplanes5, planes, stride=1, downsample=None, reduction=16):
        super(SEBlock5x5, self).__init__()
...
class SEBlock7x7(nn.Module):
    expansion = 1

    def __init__(self, inplanes7, planes, stride=1, downsample=None, reduction=16):
        super(SEBlock7x7, self).__init__()
